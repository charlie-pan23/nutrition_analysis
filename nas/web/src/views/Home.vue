...
<!--                  </el-table>-->
                  ...
                  <el-descriptions border :column="1" v-if="foodData">
                    <el-descriptions-item label="食物">{{ foodData.name }}</el-descriptions-item>
                    <el-descriptions-item label="重量(g)">{{ foodData.amount }}</el-descriptions-item>
                    <el-descriptions-item label="热量(kcal)">{{ foodData.calories }}</el-descriptions-item>
                    <el-descriptions-item label="蛋白质(g)">{{ foodData.protein }}</el-descriptions-item>
                    <el-descriptions-item label="脂肪(g)">{{ foodData.fat }}</el-descriptions-item>
                    <el-descriptions-item label="碳水化合物(g)">{{ foodData.carbs }}</el-descriptions-item>
                  </el-descriptions>
...
const analysis = async () => {
  ...
  try {
    ...
    const res = await instance.get("http://172.20.10.3:5000/analysis/test")
